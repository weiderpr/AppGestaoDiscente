...
INSERT INTO profile_permissions (profile, resource, can_access, instituicao_id) VALUES
('Administrador', 'users.index', 1, 1),
('Administrador', 'users.show', 1, 1),
('Administrador', 'users.create', 1, 1),
('Administrador', 'users.update', 1, 1),
('Administrador', 'users.delete', 1, 1),
('Administrador', 'courses.index', 1, 1),
('Coordenador', 'courses.index', 1, 1),
('Professor', 'courses.index', 1, 1),
('Pedagogo', 'courses.index', 1, 1),
('Administrador', 'courses.show', 1, 1),
('Coordenador', 'courses.show', 1, 1),
('Professor', 'courses.show', 1, 1),
('Administrador', 'courses.create', 1, 1),
('Coordenador', 'courses.create', 1, 1),
('Administrador', 'courses.update', 1, 1),
('Coordenador', 'courses.update', 1, 1),
('Administrador', 'courses.delete', 1, 1),
('Administrador', 'institutions.index', 1, 1),
('Administrador', 'institutions.manage', 1, 1),
('Administrador', 'subjects.index', 1, 1),
('Coordenador', 'subjects.index', 1, 1),
('Administrador', 'subjects.manage', 1, 1),
('Coordenador', 'subjects.manage', 1, 1),
('Administrador', 'conselhos.index', 1, 1),
('Coordenador', 'conselhos.index', 1, 1),
('Diretor', 'conselhos.index', 0, 1),
('Pedagogo', 'conselhos.index', 1, 1),
('Assistente Social', 'conselhos.index', 1, 1),
('Psicólogo', 'conselhos.index', 1, 1),
('Administrador', 'atendimentos.index', 1, 1),
('Coordenador', 'atendimentos.index', 1, 1),
('Pedagogo', 'atendimentos.index', 1, 1),
('Assistente Social', 'atendimentos.index', 1, 1),
('Psicólogo', 'atendimentos.index', 1, 1),
('Administrador', 'sancoes.index', 1, 1),
('Coordenador', 'sancoes.index', 1, 1),
('Pedagogo', 'sancoes.index', 1, 1),
('Assistente Social', 'sancoes.index', 1, 1),
('Psicólogo', 'sancoes.index', 1, 1),
('Coordenador', 'courses.delete', 0, 1),
('Coordenador', 'institutions.index', 0, 1),
('Coordenador', 'institutions.manage', 0, 1),
('Coordenador', 'users.create', 0, 1),
('Coordenador', 'users.delete', 0, 1),
('Coordenador', 'users.index', 0, 1),
('Coordenador', 'users.show', 0, 1),
('Coordenador', 'users.update', 0, 1),
('Diretor', 'atendimentos.index', 0, 1),
('Diretor', 'courses.create', 0, 1),
('Diretor', 'courses.delete', 0, 1),
('Diretor', 'courses.index', 0, 1),
('Diretor', 'courses.show', 0, 1),
('Diretor', 'courses.update', 0, 1),
('Diretor', 'institutions.index', 0, 1),
('Diretor', 'institutions.manage', 0, 1),
('Diretor', 'subjects.index', 0, 1),
('Diretor', 'subjects.manage', 0, 1),
('Diretor', 'users.create', 0, 1),
('Diretor', 'users.delete', 0, 1),
('Diretor', 'users.index', 0, 1),
('Diretor', 'users.show', 0, 1),
('Diretor', 'users.update', 0, 1),
('Professor', 'atendimentos.index', 0, 1),
('Professor', 'conselhos.index', 0, 1),
('Professor', 'courses.create', 0, 1),
('Professor', 'courses.delete', 0, 1),
('Professor', 'courses.update', 0, 1),
('Professor', 'institutions.index', 0, 1),
('Professor', 'institutions.manage', 0, 1),
('Professor', 'subjects.index', 0, 1),
('Professor', 'subjects.manage', 0, 1),
('Professor', 'users.create', 0, 1),
('Professor', 'users.delete', 0, 1),
('Professor', 'users.index', 0, 1),
('Professor', 'users.show', 0, 1),
('Professor', 'users.update', 0, 1),
('Pedagogo', 'courses.create', 0, 1),
('Pedagogo', 'courses.delete', 0, 1),
('Pedagogo', 'courses.show', 0, 1),
('Pedagogo', 'courses.update', 0, 1),
('Pedagogo', 'institutions.index', 0, 1),
('Pedagogo', 'institutions.manage', 0, 1),
('Pedagogo', 'subjects.index', 0, 1),
('Pedagogo', 'subjects.manage', 0, 1),
('Pedagogo', 'users.create', 0, 1),
('Pedagogo', 'users.delete', 0, 1),
('Pedagogo', 'users.index', 0, 1),
('Pedagogo', 'users.show', 0, 1),
('Pedagogo', 'users.update', 0, 1),
('Assistente Social', 'courses.create', 0, 1),
('Assistente Social', 'courses.delete', 0, 1),
('Assistente Social', 'courses.index', 0, 1),
('Assistente Social', 'courses.show', 0, 1),
('Assistente Social', 'courses.update', 0, 1),
('Assistente Social', 'institutions.index', 0, 1),
('Assistente Social', 'institutions.manage', 0, 1),
('Assistente Social', 'subjects.index', 0, 1),
('Assistente Social', 'subjects.manage', 0, 1),
('Assistente Social', 'users.create', 0, 1),
('Assistente Social', 'users.delete', 0, 1),
('Assistente Social', 'users.index', 0, 1),
('Assistente Social', 'users.show', 0, 1),
('Assistente Social', 'users.update', 0, 1),
('Naapi', 'atendimentos.index', 0, 1),
('Naapi', 'conselhos.index', 0, 1),
('Naapi', 'courses.create', 0, 1),
('Naapi', 'courses.delete', 0, 1),
('Naapi', 'courses.index', 0, 1),
('Naapi', 'courses.show', 0, 1),
('Naapi', 'courses.update', 0, 1),
('Naapi', 'institutions.index', 0, 1),
('Naapi', 'institutions.manage', 0, 1),
('Naapi', 'subjects.index', 0, 1),
('Naapi', 'subjects.manage', 0, 1),
('Naapi', 'users.create', 0, 1),
('Naapi', 'users.delete', 0, 1),
('Naapi', 'users.index', 0, 1),
('Naapi', 'users.show', 0, 1),
('Naapi', 'users.update', 0, 1),
('Psicólogo', 'courses.create', 0, 1),
('Psicólogo', 'courses.delete', 0, 1),
('Psicólogo', 'courses.index', 0, 1),
('Psicólogo', 'courses.show', 0, 1),
('Psicólogo', 'courses.update', 0, 1),
('Psicólogo', 'institutions.index', 0, 1),
('Psicólogo', 'institutions.manage', 0, 1),
('Psicólogo', 'subjects.index', 0, 1),
('Psicólogo', 'subjects.manage', 0, 1),
('Psicólogo', 'users.create', 0, 1),
('Psicólogo', 'users.delete', 0, 1),
('Psicólogo', 'users.index', 0, 1),
('Psicólogo', 'users.show', 0, 1),
('Psicólogo', 'users.update', 0, 1),
('Outro', 'atendimentos.index', 0, 1),
('Outro', 'conselhos.index', 0, 1),
('Outro', 'courses.create', 0, 1),
('Outro', 'courses.delete', 0, 1),
('Outro', 'courses.index', 0, 1),
('Outro', 'courses.show', 0, 1),
('Outro', 'courses.update', 0, 1),
('Outro', 'institutions.index', 0, 1),
('Outro', 'institutions.manage', 0, 1),
('Outro', 'subjects.index', 0, 1),
('Outro', 'subjects.manage', 0, 1),
('Outro', 'users.create', 0, 1),
('Outro', 'users.delete', 0, 1),
('Outro', 'users.index', 0, 1),
('Outro', 'users.show', 0, 1),
('Outro', 'users.update', 0, 1),
('Outro', 'sancoes.index', 0, 1),
('Administrador', 'courses.manage', 1, 1),
('Coordenador', 'courses.manage', 1, 1),
('Administrador', 'students.index', 1, 1),
('Coordenador', 'students.index', 1, 1),
('Professor', 'students.index', 1, 1),
('Pedagogo', 'students.index', 1, 1),
('Assistente Social', 'students.index', 1, 1),
('Naapi', 'students.index', 1, 1),
('Psicólogo', 'students.index', 1, 1),
('Administrador', 'students.manage', 1, 1),
('Coordenador', 'students.manage', 1, 1),
('Administrador', 'students.comments', 1, 1),
('Coordenador', 'students.comments', 1, 1),
('Professor', 'students.comments', 1, 1),
('Pedagogo', 'students.comments', 1, 1),
('Assistente Social', 'students.comments', 1, 1),
('Naapi', 'students.comments', 1, 1),
('Psicólogo', 'students.comments', 1, 1),
('Diretor', 'students.comments', 0, 1),
('Outro', 'students.comments', 0, 1),
('Administrador', 'grades.manage', 1, 1),
('Coordenador', 'grades.manage', 1, 1),
('Professor', 'grades.manage', 1, 1),
('Administrador', 'coordinators.manage', 1, 1),
('Administrador', 'representantes.manage', 1, 1),
('Coordenador', 'representantes.manage', 1, 1),
('Administrador', 'survey.index', 1, 1),
('Coordenador', 'survey.index', 1, 1),
('Coordenador', 'coordinators.manage', 0, 1),
('Diretor', 'coordinators.manage', 0, 1),
('Diretor', 'courses.manage', 0, 1),
('Diretor', 'grades.manage', 0, 1),
('Diretor', 'representantes.manage', 0, 1),
('Diretor', 'students.index', 0, 1),
('Diretor', 'students.manage', 0, 1),
('Diretor', 'survey.index', 0, 1),
('Professor', 'coordinators.manage', 0, 1),
('Professor', 'courses.manage', 0, 1),
('Professor', 'representantes.manage', 0, 1),
('Professor', 'settings.index', 0, 1),
('Professor', 'students.manage', 0, 1),
('Professor', 'survey.index', 0, 1),
('Pedagogo', 'coordinators.manage', 0, 1),
('Pedagogo', 'courses.manage', 0, 1),
('Pedagogo', 'grades.manage', 0, 1),
('Pedagogo', 'representantes.manage', 0, 1),
('Pedagogo', 'students.manage', 0, 1),
('Pedagogo', 'survey.index', 0, 1),
('Assistente Social', 'coordinators.manage', 0, 1),
('Assistente Social', 'courses.manage', 0, 1),
('Assistente Social', 'grades.manage', 0, 1),
('Assistente Social', 'representantes.manage', 0, 1),
('Assistente Social', 'students.manage', 0, 1),
('Assistente Social', 'survey.index', 0, 1),
('Naapi', 'coordinators.manage', 0, 1),
('Naapi', 'courses.manage', 0, 1),
('Naapi', 'grades.manage', 0, 1),
('Naapi', 'representantes.manage', 0, 1),
('Naapi', 'settings.index', 0, 1),
('Naapi', 'students.manage', 0, 1),
('Naapi', 'survey.index', 0, 1),
('Psicólogo', 'coordinators.manage', 0, 1),
('Psicólogo', 'courses.manage', 0, 1),
('Psicólogo', 'grades.manage', 0, 1),
('Psicólogo', 'representantes.manage', 0, 1),
('Psicólogo', 'students.manage', 0, 1),
('Psicólogo', 'survey.index', 0, 1),
('Outro', 'coordinators.manage', 0, 1),
('Outro', 'courses.manage', 0, 1),
('Outro', 'grades.manage', 0, 1),
('Outro', 'representantes.manage', 0, 1),
('Outro', 'settings.index', 0, 1),
('Outro', 'students.index', 0, 1),
('Outro', 'students.manage', 0, 1),
('Outro', 'survey.index', 0, 1),
('Administrador', 'settings.backup', 1, 1),
('Administrador', 'settings.avaliacoes', 1, 1),
('Administrador', 'settings.permissoes', 1, 1),
('Coordenador', 'settings.avaliacoes', 1, 1),
('Coordenador', 'settings.backup', 0, 1),
('Coordenador', 'settings.permissoes', 0, 1),
('Diretor', 'settings.avaliacoes', 0, 1),
('Diretor', 'settings.backup', 0, 1),
('Diretor', 'settings.permissoes', 0, 1),
('Professor', 'settings.avaliacoes', 0, 1),
('Professor', 'settings.backup', 0, 1),
('Professor', 'settings.permissoes', 0, 1),
('Pedagogo', 'settings.avaliacoes', 0, 1),
('Pedagogo', 'settings.backup', 0, 1),
('Pedagogo', 'settings.permissoes', 0, 1),
('Assistente Social', 'settings.avaliacoes', 0, 1),
('Assistente Social', 'settings.backup', 0, 1),
('Assistente Social', 'settings.permissoes', 0, 1),
('Naapi', 'settings.avaliacoes', 0, 1),
('Naapi', 'settings.backup', 0, 1),
('Naapi', 'settings.permissoes', 0, 1),
('Psicólogo', 'settings.avaliacoes', 0, 1),
('Psicólogo', 'settings.backup', 0, 1),
('Psicólogo', 'settings.permissoes', 0, 1),
('Outro', 'settings.avaliacoes', 0, 1),
('Outro', 'settings.backup', 0, 1),
('Outro', 'settings.permissoes', 0, 1),
('Administrador', 'settings.index', 1, 1),
('Coordenador', 'settings.index', 1, 1),
('Diretor', 'settings.index', 1, 1),
('Pedagogo', 'settings.index', 1, 1),
('Assistente Social', 'settings.index', 1, 1),
('Psicólogo', 'settings.index', 1, 1),
('Administrador', 'courses.view_all', 1, 1),
('Pedagogo', 'courses.view_all', 1, 1),
('Assistente Social', 'courses.view_all', 1, 1),
('Psicólogo', 'courses.view_all', 1, 1),
('Coordenador', 'courses.view_all', 0, 1),
('Diretor', 'courses.view_all', 0, 1),
('Professor', 'courses.view_all', 0, 1),
('Naapi', 'courses.view_all', 0, 1),
('Outro', 'courses.view_all', 0, 1)
