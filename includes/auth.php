...
function getCurrentUser(): ?array {
    ...
    $db = getDB();
    $stmt = $db->prepare('SELECT id, name, email, phone, photo, profile, is_teacher, theme FROM users WHERE id = ? AND is_active = 1');
